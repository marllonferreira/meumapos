...
<div class="row-fluid" style="margin-top: 0">
    ...
    if (!empty($zapnumber)) {
        echo '<a title="Enviar Por WhatsApp" class="button btn btn-mini btn-success" id="enviarWhatsApp" target="whatsapp" href="https://web.whatsapp.com/send?phone=55' . $zapnumber . '&text=' . $texto_de_notificacao . '">
                                        ...
                                        <ul>
                                            <li>
                                                <span>
                                                    ...
                                                    <span> E-mail: <?php echo $result->email ?></span><br><?php } ?>
													<!-- fim -->
